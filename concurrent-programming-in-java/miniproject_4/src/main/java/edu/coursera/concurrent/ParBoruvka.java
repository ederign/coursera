...
public final class ParBoruvka extends AbstractBoruvka<ParBoruvka.ParComponent> {
        ...
        for (int i = 0; i < numberThreads; i++) {
            threads[i] = new Thread(() -> {
                ...
                while ((currentNode = nodesLoaded.poll()) != null) {
                    ...
                    final Edge<ParComponent> e = currentNode.getMinEdge();
                    if (e == null) {
                        result[0] = currentNode;
                        break;
                    }

                    final ParComponent other = e.getOther(currentNode);
    ...
    public static final class ParComponent extends Component<ParComponent> {
         ...
         */
        public void merge(final ParComponent other,
            ...
            while (i + j < edges.size() + other.edges.size()) {
                ...
                if (j < other.edges.size() && (i >= edges.size()
                    ...
                    newEdges.add(edges.get(i++).replaceComponent(other,
                                                                 this));
                }
            }
            other.edges.clear();
    ...
    public static final class ParEdge extends Edge<ParComponent>
         ...
         */
        public ParEdge(final ParComponent from,
